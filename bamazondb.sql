...
VALUES 
("Sony Alpha a6000 Mirrorless Digital Camera with 16-50mm Power Zoom Lens", "Electronics", 598.01, 15),
("ThermoPro TP55 Digital Hygrometer Indoor Thermometer Humidity Gauge", "Electronics", 29.99, 5),
("Born a Crime: Stories from a South African Childhood", "Books", 28.03, 23),
